...
```
+ provider hashicorp.com/rc/tos v1.5.1
```
...
__Updated__
- __datasource tos_application_packs:__ "interfaces" flag added. "interfaces" displays Application Interfaces with Interface Name and Tags.
