...
* `interfaces` - List of Application Interfaces with Interface Name and Tag Name. List only the application interfaces that has tag. 
...
application_packs = [
  {
    ...
    interfaces     = [
      {
        name = "Application Interface 1"
        tag = "tag-1"
      },
      {
        name = "Application Interface 2"
        tag = "tag-2"
      },
    ]
  },
